...
baseOutDir = 'results/ReReco2016/tnpPhoID/etabin300_abseta'
...
samplesDef = {
    ...
    'data'   : tnpSamples.ExoReReco2016['data_Run2016Bv2'].clone(),
    # 'mcNom'  : tnpSamples.ExoReReco2016['DY_madgraph'].clone(),
    'mcNom'  : tnpSamples.ExoReReco2016['DY_madgraph_HTbinned'].clone(),
    'mcAlt'  : tnpSamples.ExoReReco2016['DY_amcatnlo'].clone(),
    # 'tagSel' : tnpSamples.ExoReReco2016['DY_madgraph'].clone(),
    'tagSel' : tnpSamples.ExoReReco2016['DY_madgraph_HTbinned'].clone(),
}
## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016C'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016D'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016E'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016F'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016G'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2016['data_Run2016H'] )
