...
baseOutDir = 'results/ReReco2018/tnpPhoID/etabin300_abseta'
...
samplesDef = {
    # 'data'   : tnpSamples.ExoReReco2018['data'].clone(),
    # 'mcNom'  : tnpSamples.ExoReReco2018['mc'].clone(),

    'data'   : tnpSamples.ExoReReco2018['data_Run2018A'].clone(),
    # 'mcNom'  : tnpSamples.ExoReReco2018['DY_madgraph'].clone(),
    'mcNom'  : tnpSamples.ExoReReco2018['DY_madgraph_HTbinned'].clone(),
    'mcAlt'  : tnpSamples.ExoReReco2018['DY_amcatnloext'].clone(),
    # 'tagSel' : tnpSamples.ExoReReco2018['DY_madgraph'].clone(),
    'tagSel' : tnpSamples.ExoReReco2018['DY_madgraph_HTbinned'].clone(),
}
## can add data sample easily
samplesDef['data'].add_sample( tnpSamples.ExoReReco2018['data_Run2018B'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2018['data_Run2018C'] )
samplesDef['data'].add_sample( tnpSamples.ExoReReco2018['data_Run2018D'] )

# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-100to200'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-200to400'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-400to600'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-600to800'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-800to1200'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-1200to2500'] )
# samplesDef['mcNom'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-2500toInf'] )

# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-100to200'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-200to400'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-400to600'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-600to800'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-800to1200'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-1200to2500'] )
# samplesDef['tagSel'].add_sample( tnpSamples.ExoReReco2018['DY_madgraph_HT-2500toInf'] )
...
# weightName = 'weights_2018_run2018.totWeight'
# if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
# if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
# if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
...
tnpParAltBkgFit = [
    ...
    "linearF[0.001,-1,100]","parabolicF[0,-50,50]",
    ]
